...
class GoogleMapPlacePicker extends StatelessWidget {
  ...
  Widget _buildGoogleMapInner(
      PlaceProvider? provider, MapType mapType, List<Marker> markers) {
  ...
  Widget _buildGoogleMap(BuildContext context) {
    return Selector<PlaceProvider, MapType>(
        ...
        builder: (_, data, __) => this._buildGoogleMapInner(
            PlaceProvider.of(context, listen: false), data, markers));
  }
  ...
  Widget _buildMapIcons(BuildContext context) {
    ...
    return Positioned(
      top: appBarRenderBox.size.height + (topMargin ?? 0),
      right: endMargin,
      child: Column(
        children: <Widget>[
          enableMapTypeButton!
